/**
 * @file scenario_3_30.c
 * @brief Scenariusz Testowy 3 - Odwrócona Asymetria / Sortowanie Rosnące (n = 30 zadań)
 *
 ...
 * według czasu trwania (fx1-fx6 na Rdzeniu 0 oraz fx7-fx12 na Rdzeniu 1). Faza równoległa
 * (Dual) realizuje wykonanie 12 par wariantu elastycznego oraz 6 zadań barierowych tła,
 * zachowując ścisłe sortowanie rosnące (SJF - Shortest Job First) względem ich czasu barierowego.
 */
...
static void task_runner_core1(void *arg) {
    while (1) {
        ...
        /* Zadania mono na rdzeniu 1 sformatowane w porządku rosnącym (od 8 ms do 18 ms) */
        execute_mono_task("fx7", 8000);
        execute_mono_task("fx8", 10000);
        execute_mono_task("fx9", 12000);
        execute_mono_task("fx10", 14000);
        execute_mono_task("fx11", 16000);
        execute_mono_task("fx12", 18000);

        xTaskNotifyGive(h_core0);
    }
}

/* ── RDZEŃ 0: GŁÓWNY ZARZĄDCA PĘTLI (Scenariusz 3, n=30) ───────── */
static void task_runner_core0(void *arg) {
    ...
    while (1) {
        ...
        /* Zadania mono na rdzeniu 0 sformatowane w porządku rosnącym (od 2 ms do 7 ms) */
        ...
        execute_dual_task("fx9_0_d", "fx9_1_d", 18000);
        execute_dual_task("fx10_0_d", "fx10_1_d", 20000);
        execute_dual_task("fx11_0_d", "fx11_1_d", 22000);
        execute_dual_task("fx12_0_d", "fx12_1_d", 24000);

        /* Faza zadań dualnych tła, umieszczona na końcu według kryterium SJF */
        execute_dual_task("t1_0_d", "t1_1_d", 28000);
        execute_dual_task("t2_0_d", "t2_1_d", 32000);
        execute_dual_task("t3_0_d", "t3_1_d", 36000);
        execute_dual_task("t4_0_d", "t4_1_d", 40000);
        execute_dual_task("t5_0_d", "t5_1_d", 42000);
        execute_dual_task("t6_0_d", "t6_1_d", 44000);
