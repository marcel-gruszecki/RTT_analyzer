/**
 * @file scenario_2_30.c
 * @brief Scenariusz Testowy 2 - Elastyczna Asymetria (n = 30 zadań)
 *
 ...
 * Scenariusz wprowadza głęboką asymetrię obciążeń – Rdzeń 0 wykonuje sekwencję dwunastu
 * zadań jednordzeniowych (grupa fx1-fx12 o długości 15 ms każde), podczas gdy Rdzeń 1
 * pozostaje bezczynny w oczekiwaniu na synchronizację barierową. Następnie te same zadania
 * powtarzane są jako dualne obok dedykowanego tła, dostarczając zróżnicowanych par
 * mono-dual do walidacji elastyczności szeregowania.
 */
...
/* ── RDZEŃ 0: NIESKOŃCZONA PĘTLA GŁÓWNA (Asymetria, n=30) ──────────────── */
static void task_runner_core0(void *arg) {
    vTaskDelay(pdMS_TO_TICKS(100));

    while (1) {
        /* Faza zadań mono na rdzeniu 0 (baza pod asymetrię) - 12 zadań, łącznie 180 ms */
        xTaskNotifyGive(h_core1);

        /* Grupa fx1 - fx6 */
        execute_mono_task("fx1", 15000);
        execute_mono_task("fx2", 15000);
        execute_mono_task("fx3", 15000);
        execute_mono_task("fx4", 15000);
        execute_mono_task("fx5", 15000);
        execute_mono_task("fx6", 15000);

        /* Grupa fx7 - fx12 */
        execute_mono_task("fx7",  15000);
        execute_mono_task("fx8",  15000);
        execute_mono_task("fx9",  15000);
        execute_mono_task("fx10", 15000);
        execute_mono_task("fx11", 15000);
        execute_mono_task("fx12", 15000);

        ulTaskNotifyTake(pdTRUE, portMAX_DELAY);

        /* Faza zadań dualnych - powtórzenie zadań wariantu elastycznego (fx1 - fx12) */
        execute_dual_task("fx1_0_d",  "fx1_1_d",  3000);
        execute_dual_task("fx2_0_d",  "fx2_1_d",  3000);
        execute_dual_task("fx3_0_d",  "fx3_1_d",  3000);
        execute_dual_task("fx4_0_d",  "fx4_1_d",  3000);
        execute_dual_task("fx5_0_d",  "fx5_1_d",  3000);
        execute_dual_task("fx6_0_d",  "fx6_1_d",  3000);

        execute_dual_task("fx7_0_d",  "fx7_1_d",  3000);
        execute_dual_task("fx8_0_d",  "fx8_1_d",  3000);
        execute_dual_task("fx9_0_d",  "fx9_1_d",  3000);
        execute_dual_task("fx10_0_d", "fx10_1_d", 3000);
        execute_dual_task("fx11_0_d", "fx11_1_d", 3000);
        execute_dual_task("fx12_0_d", "fx12_1_d", 3000);

        /* Faza zadań dualnych - wykonanie dedykowanego tła bez odpowiedników mono */
        execute_dual_task("t7_0_d",  "t7_1_d",  2000);
        execute_dual_task("t8_0_d",  "t8_1_d",  2000);
        execute_dual_task("t9_0_d",  "t9_1_d",  2000);
        execute_dual_task("t10_0_d", "t10_1_d", 2000);
        execute_dual_task("t11_0_d", "t11_1_d", 2000);
        execute_dual_task("t12_0_d", "t12_1_d", 2000);
