/**
 * @file scenario_2_10.c
 * @brief Scenariusz Testowy 2 - Elastyczna Asymetria (n = 10 zadań)
 *
 ...
 * Wprowadza kontrolowaną asymetrię obciążeń – Rdzeń 0 wykonuje dwa długie zadania mono
 * (po 40 ms), podczas gdy Rdzeń 1 oczekuje bezczynnie na synchronizację. W dalszej fazie
 * te same zadania są powtarzane w wariantach dualnych wraz z zadaniami tła, co pozwala
 * parserowi i algorytmom na bezpośrednie porównanie efektywności struktur mono vs dual.
 */
...
/* ── RDZEŃ 0: NIESKOŃCZONA PĘTLA GŁÓWNA (Asymetria, n=10) ──────────────── */
static void task_runner_core0(void *arg) {
    ...
    while (1) {
        ...
        execute_mono_task("fx1", 40000);
        execute_mono_task("fx2", 40000);
