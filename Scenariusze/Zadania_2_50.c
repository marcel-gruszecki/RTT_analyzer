/**
 * @file scenario_2_50.c
 * @brief Scenariusz Testowy 2 - Elastyczna Asymetria (n = 50 zadań)
 *
 ...
 * w wariantach dualnych, a uzupełnienie struktury stanowi 10 dedykowanych zadań tła.
 */
...
/* ── RDZEŃ 0: NIESKOŃCZONA PĘTLA GŁÓWNA (Asymetria, n=50) ──────────────── */
static void task_runner_core0(void *arg) {
    ...
    while (1) {
        ...
        /* Faza zadań dualnych - wykonanie dedykowanego tła bez odpowiedników mono (t1 - t10) */
        execute_dual_task("t1_0_d", "t1_1_d", 2000); execute_dual_task("t2_0_d", "t2_1_d", 2000);
        execute_dual_task("t3_0_d", "t3_1_d", 2000); execute_dual_task("t4_0_d", "t4_1_d", 2000);
        execute_dual_task("t5_0_d", "t5_1_d", 2000); execute_dual_task("t6_0_d", "t6_1_d", 2000);
        execute_dual_task("t7_0_d", "t7_1_d", 2000); execute_dual_task("t8_0_d", "t8_1_d", 2000);
        execute_dual_task("t9_0_d", "t9_1_d", 2000); execute_dual_task("t10_0_d", "t10_1_d", 2000);
...
void app_main(void) {
    ...
    xTaskCreatePinnedToCore(vDualWorkerTaskCore1, "dual_worker", 4096, NULL, 12, NULL, 1);
